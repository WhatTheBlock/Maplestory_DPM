...
info <- c(745 + 2 * IlliumSpec$SkillLv, 8, 0, NA, 4, T, T, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(745 + 2 * IlliumSpec$SkillLv, 2, 0, NA, 4, T, T, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("IGR", "FDR"), levels=ASkill)
value <- c(ifelse(GetCoreLv(IlliumCore, "Machina_Domination")>=40, 20, 0), FDRCalc(c(2 * GetCoreLv(IlliumCore, "Machina_Domination"), floor(GetCoreLv(IlliumCore, "OverloadMana") / 10) + 8)))
info <- c((745 + 2 * IlliumSpec$SkillLv) * (0.01 * GetCoreLv(IlliumCore, "SoulofCrystal") + 0.5), 2, 0, NA, 4, T, T, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("IGR", "BDR", "FDR"), levels=ASkill)
value <- c(ifelse(GetCoreLv(IlliumCore, "Destruction")>=40, 20, 0), 20, FDRCalc(c(2 * GetCoreLv(IlliumCore, "Destruction"), floor(GetCoreLv(IlliumCore, "OverloadMana") / 10) + 8)))
info <- c((745 + 2 * IlliumSpec$SkillLv) * (0.01 * GetCoreLv(IlliumCore, "SoulofCrystal") + 0.5), 8, 0, NA, 4, T, T, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(395 + 2 * IlliumSpec$SkillLv, 12, 690, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("IGR", "BDR", "FDR"), levels=ASkill)
value <- c(ifelse(GetCoreLv(IlliumCore, "Javelin_EnhancedJavelin")>=40, 20, 0), 40, FDRCalc(c(2 * GetCoreLv(IlliumCore, "Javelin_EnhancedJavelin"), floor(GetCoreLv(IlliumCore, "OverloadMana") / 10) + 8)))
info <- c(395 + 2 * IlliumSpec$SkillLv, 4, 690, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(500 + 3 * IlliumSpec$SkillLv, 7, 540, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(310 + 4 * IlliumSpec$SkillLv, 1, 690, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
Orb <- rbind(data.frame(option, value), info)

option <- factor(c("IGR", "BDR", "FDR"), levels=ASkill)
value <- c(ifelse(GetCoreLv(IlliumCore, "Longinus")>=40, 20, 0), 20, FDRCalc(c(2 * GetCoreLv(IlliumCore, "Longinus"), floor(GetCoreLv(IlliumCore, "OverloadMana") / 10) + 8)))
info <- c(950 + 10 * IlliumSpec$SkillLv, 8, 780, NA, 15, T, T, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
Longinus <- rbind(data.frame(option, value), info)
...
info <- c(700 + 28 * GetCoreLv(IlliumCore, "CrystalIgnition"), 5, 9340, 120, 180, T, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "FDR"), levels=ASkill)
value <- c(20, floor(GetCoreLv(IlliumCore, "OverloadMana") / 10) + 8)
info <- c(950 + 38 * GetCoreLv(IlliumCore, "CrystalIgnition"), 6, 0, 1000, 180, T, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
IlliumATK <- Attack(list(MotalSwing=MotalSwing, Destruction=Destruction, Domination=Domination, DestructionSoul=DestructionSoul, DominationSoul=DominationSoul, 
                         ...
                         Longinus=Longinus, MotalWingBeat=MotalWingBeat, CurseMark=CurseMark, CurseMarkJavelin=CurseMarkJavelin, CrystalIgnitionPre=CrystalIgnitionPre, CrystalIgnition=CrystalIgnition, 
...
ATKFinal$Delay[c(-17, -18, -19)] <- Delay(ATKFinal$Delay, IlliumSpec$ATKSpeed)[c(-17, -18, -19)]
...
IlliumSkipATK$Javelin <- c(rep(F, 11), T, rep(F, 11))
IlliumSkipATK$Orb <- c(rep(F, 5), T, rep(F, 17))
IlliumSkipATK$SkippedDelay <- c(rep(0, 5), Delay(500, IlliumSpec$ATKSpeed), rep(0, 5), Delay(500, IlliumSpec$ATKSpeed), rep(0, 11))
