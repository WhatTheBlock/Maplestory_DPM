...
option <- factor(levels=BSkill)
value <- c()
info <- c(90 + 3 * ceiling(LaraBase$PSkillLv/2), 0, Delay(690, 2), T, NA, NA, T)
info <- data.frame(BInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(340, 4, 660, NA, NA, NA, NA, F)
...
info <- c(105 + 45 + 260 + 8 * LaraSpec$PSkillLv, 3 * 0.7, 0, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(55 + 75 + 265 + 7 * LaraSpec$PSkillLv, 1, 510, 2000, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c()
info <- c(600 + 24 * GetCoreLv(LaraCore, "HugeStretch"), 5 * 5, 870, 90, 60, T, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c()
info <- c((600 + 24 * GetCoreLv(LaraCore, "HugeStretch")) * 0.7, 5 * 5, 0, 90, 60, T, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c()
info <- c(830 + 34 * GetCoreLv(LaraCore, "SunRiverMountWind"), 10, 840, NA, 180, T, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c()
info <- c(1015 + 41 * GetCoreLv(LaraCore, "SunRiverMountWind"), 15, 0, NA, 180, T, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c()
info <- c(520 + 20 * GetCoreLv(LaraCore, "SurgingSpirit"), 8, 630, NA, 20, T, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c()
info <- c(300 + 12 * GetCoreLv(LaraCore, "RidgeZigzag"), 4 * 3, 960, 390, 60, T, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
